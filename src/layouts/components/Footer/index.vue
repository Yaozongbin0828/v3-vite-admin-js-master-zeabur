<template>
  <footer class="layout-footer">
    <a href="https://github.com/yaozongbin/v3-vite-admin-js-master">
      MIT © 2023-PRESENT @yaozongbin
    </a>
  </footer>
</template>
...
.layout-footer {
  ...
  min-height: var(--v3-footer-height);
  display: flex;
  align-items: center;
  ...
  a {
    display: var(--v3-footer-display-none);
    font-size: 14px;
  }
